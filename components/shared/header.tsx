                    ...
                    {servicesDropdownContent.sections.map((section, idx) => (
                      <div key={idx}>
                        {section.href ? (
                          ...
                          >
                            <h3 className="text-[12px] font-light text-primary-grey/text mb-1 pb-1 border-b border-primary-purple group-hover:text-primary-green transition-all w-fit">
                              {section.title}
                            </h3>
                            {section.description && (
                              <p className="text-[12px] font-light text-primary-grey/text leading-[13px] group-hover:text-primary-green transition-all">
                                {section.description}
                              </p>
                            )}
                          </Link>
                          ...
                          <>
                            <h3 className="text-[12px] font-light text-primary-grey/text mb-2 pb-1 border-b border-primary-purple w-fit">
                              {section.title}
                            </h3>
                            {section.items && (
                                ...
                                {section.items.map((item, itemIdx) => (
                                  <li key={itemIdx}>
                                    <Link
                                      href={item.href}
                                      onClick={() => setActiveDropdown(null)}
                                      className="text-[12px] font-light text-primary-grey/text hover:text-primary-green transition-all w-fit block"
                                    >
                                      • {item.label}
                                    </Link>
                                  </li>
