    ...
    <div className="max-w-[1117px] mx-auto flex items-start justify-between font-nunito">
      <div className="grid grid-cols-2 gap-[40px] w-fit">
        {cards.map((service, index) => (
          ...
          >
            <div className="flex flex-col items-center justify-start pt-[20px] pr-[12px] pb-[20px] pl-[17px] gap-[9px] transition-all duration-500 group-hover:-translate-y-12">
              <Image
                src={service.image}
                alt={service.title}
                width={85}
            ...
            <div className="absolute bottom-3 left-0 w-full p-4 translate-y-full opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 bg-transparent">
