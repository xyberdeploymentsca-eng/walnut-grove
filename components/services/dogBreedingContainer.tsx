...
export const DogBreedingContainer = () => {
  const points = [
    "Reproductive health evaluations to assess breeding readiness and overall health.",
    "Breeding consultations and planning to support responsible breeding practices.",
