...
export const SpayNeuterContainer = () => {
  const points = [
    "Lower Risk of Hormone-Driven Aggression: Supports more stable behavioral patterns.",
    "Prevention of Unplanned Litters: Responsible population control and community health.",
